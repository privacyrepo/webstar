/* -------------------------------------------------------
 ...
 Theme Name: webstar - You web development service
 Theme URL: https://webstarhtml.themezaa.com/
 Description: Elevate your online presence with webstar - a modern, versatile, multipurpose Bootstrap 5 responsive HTML5, SCSS template using highly creative 52+ ready demos.
...
(function ($) {
    ...
    if (typeof $.fn.magnificPopup === 'function') {
        if ($('#subscribe-popup').length > 0) {
            let delaySecond = 1.5,
                    expireDays = 30,
                    cookieName = 'webstar-promo-popup';
